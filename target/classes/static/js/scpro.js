...
// ==========================================================
// 🔹 Initialize page when "scPro" page is loaded
// ==========================================================
...
// ==========================================================
// 🔹 Popup: Required Fields before Upload
// ==========================================================
...
// ==========================================================
// 🔹 Run Test Suite (updated to support CSV download links)
// ==========================================================
  ...
  try {
    ...
    if (data.status === "success") {
      ...
      if (data.htmlReportUrl) {
        testReporter(
          `<a href="${data.htmlReportUrl}" target="_blank" class="btn-report">📄 View HTML Report</a>`
        );
      }

      // 🔹 CSV Download Links (from new 'csvReports' format)
