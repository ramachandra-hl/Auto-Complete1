...
public class ConvertRoomsProfileType extends RoomModuleHandler {
    private static final Logger logger = Logger.getLogger(ConvertRoomsProfileType.class.getName());
